function WebGL(CID, FSID, VSID){
	...
	if(!canvas.getContext("lesson14-canvas") && !canvas.getContext("experimental-webgl"))
		alert("Your Browser Doesn't Support WebGL");
	else
	{
		this.GL = (canvas.getContext("lesson14-canvas")) ? canvas.getContext("lesson14-canvas") : canvas.getContext("experimental-webgl");	
